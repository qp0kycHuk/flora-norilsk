...
/***/ "./src/js/functions/getSupportedEvents.js":
/*!************************************************!*\
  !*** ./src/js/functions/getSupportedEvents.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
var init = function init() {
  var listings = document.querySelectorAll('.-list-');
  listings.forEach(function (el) {
    var listingBtn = el.querySelector('.-list-show-');
    var listingHidden = el.querySelectorAll('.-list-el-hid-');
    listingBtn.addEventListener('click', function () {
      for (var i = 0; i < listingHidden.length; i++) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _functions_getSupportedEvents__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./functions/getSupportedEvents */ "./src/js/functions/getSupportedEvents.js");


function Range(selector, params) {
  var covers = document.querySelectorAll(selector);
  Array.from(covers).map(function (cover) {
    var _cover$getAttribute, _cover$getAttribute2, _cover$getAttribute3, _cover$getAttribute4, _cover$getAttribute5, _cover$getAttribute6;

    var options = {};
    options.$el = cover;
    options.min = (_cover$getAttribute = +cover.getAttribute('data-min')) !== null && _cover$getAttribute !== void 0 ? _cover$getAttribute : 0;
    options.max = (_cover$getAttribute2 = +cover.getAttribute('data-max')) !== null && _cover$getAttribute2 !== void 0 ? _cover$getAttribute2 : 100;
    options.from = (_cover$getAttribute3 = +cover.getAttribute('data-from')) !== null && _cover$getAttribute3 !== void 0 ? _cover$getAttribute3 : options.min;
    options.to = (_cover$getAttribute4 = +cover.getAttribute('data-to')) !== null && _cover$getAttribute4 !== void 0 ? _cover$getAttribute4 : options.max;
    options.type = (_cover$getAttribute5 = cover.getAttribute('data-type')) !== null && _cover$getAttribute5 !== void 0 ? _cover$getAttribute5 : 'single';
    options.floor = (_cover$getAttribute6 = +cover.getAttribute('data-floor')) !== null && _cover$getAttribute6 !== void 0 ? _cover$getAttribute6 : 2;
  ...
  function addListeners(options) {
    var _options$inputFrom, _options$inputTo;

    options.inner.addEventListener((0,_functions_getSupportedEvents__WEBPACK_IMPORTED_MODULE_0__["default"])().start, function (e) {
      var event = eventsUnify(e);
      if ((0,_functions_getSupportedEvents__WEBPACK_IMPORTED_MODULE_0__["default"])().type == 'mouse' && event.button !== 0) return;
      ...
      document.addEventListener((0,_functions_getSupportedEvents__WEBPACK_IMPORTED_MODULE_0__["default"])().move, moveHandler);
      document.addEventListener((0,_functions_getSupportedEvents__WEBPACK_IMPORTED_MODULE_0__["default"])().end, function () {
        ...
        document.removeEventListener((0,_functions_getSupportedEvents__WEBPACK_IMPORTED_MODULE_0__["default"])().move, moveHandler);
      });
    });
    (_options$inputFrom = options.inputFrom) === null || _options$inputFrom === void 0 ? void 0 : _options$inputFrom.addEventListener('input', function (event) {
      if (!event.target.value || isNaN(parseFloat(event.target.value))) {
        return;
      }

      var key = setFromTo(options, event.target.value, 'from');
      render(options);
    });
    (_options$inputTo = options.inputTo) === null || _options$inputTo === void 0 ? void 0 : _options$inputTo.addEventListener('input', function (event) {
      if (!event.target.value || isNaN(parseFloat(event.target.value))) {
        return;
      }

      var key = setFromTo(options, event.target.value, 'to');
      render(options);
    });
  }
...
function swipe(el, settings) {
  ...
  var distY = 0;
  var startTime = 0;
  var events = (0,_functions_getSupportedEvents__WEBPACK_IMPORTED_MODULE_0__["default"])();
  if (_functions_getSupportedEvents__WEBPACK_IMPORTED_MODULE_0__.support.pointer && !_functions_getSupportedEvents__WEBPACK_IMPORTED_MODULE_0__.support.touch || events.type === "mouse") isMouse = true;
  ...
  function checkStart(e) {
    var event = eventsUnify(e);
    if (_functions_getSupportedEvents__WEBPACK_IMPORTED_MODULE_0__.support.touch && typeof e.touches !== "undefined" && e.touches.length !== 1) return;
    dir = "none";
    dist = 0;
    startX = event.pageX;
    startY = event.pageY;
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _functions_getCookie__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./functions/getCookie */ "./src/js/functions/getCookie.js");
...
function setTheme(theme) {
  ...
  activeTheme = theme;
  var changers = document.querySelectorAll('.-theme-changer-');
  Array.from(changers).forEach(function (element) {
    if (theme.name == 'dark') {
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _js_show_pass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./js/show-pass */ "./src/js/show-pass.js");
/* harmony import */ var _js_fancybox__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/fancybox */ "./src/js/fancybox.js");
/* harmony import */ var _js_listing__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/listing */ "./src/js/listing.js");
/* harmony import */ var _js_range_slider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js/range-slider */ "./src/js/range-slider.js");
/* harmony import */ var _js_theme__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js/theme */ "./src/js/theme.js");
/* harmony import */ var _js_slide_event__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./js/slide-event */ "./src/js/slide-event.js");
/* harmony import */ var npm_kit_tab__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! npm-kit-tab */ "./node_modules/npm-kit-tab/index.js");
/* harmony import */ var npm_kit_toggle__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! npm-kit-toggle */ "./node_modules/npm-kit-toggle/index.js");
/* harmony import */ var npm_kit_ripple__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! npm-kit-ripple */ "./node_modules/npm-kit-ripple/index.js");
...
swiper__WEBPACK_IMPORTED_MODULE_9__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_9__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_9__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_9__.Scrollbar, swiper__WEBPACK_IMPORTED_MODULE_9__.Autoplay, swiper__WEBPACK_IMPORTED_MODULE_9__.Grid, swiper__WEBPACK_IMPORTED_MODULE_9__.Thumbs, swiper__WEBPACK_IMPORTED_MODULE_9__.EffectFade, swiper__WEBPACK_IMPORTED_MODULE_9__.Lazy]);
swiper__WEBPACK_IMPORTED_MODULE_9__["default"].defaults.touchStartPreventDefault = false;
window.Swiper = swiper__WEBPACK_IMPORTED_MODULE_9__["default"];
window.ripple = npm_kit_ripple__WEBPACK_IMPORTED_MODULE_8__["default"];
...
function loadHandler() {
  ...
  _js_show_pass__WEBPACK_IMPORTED_MODULE_0__["default"].init();
  _js_listing__WEBPACK_IMPORTED_MODULE_2__["default"].init();
  _js_range_slider__WEBPACK_IMPORTED_MODULE_3__["default"].init();
  npm_kit_tab__WEBPACK_IMPORTED_MODULE_6__["default"].init();
  npm_kit_toggle__WEBPACK_IMPORTED_MODULE_7__["default"].init();
  npm_kit_ripple__WEBPACK_IMPORTED_MODULE_8__["default"].init();
  _js_theme__WEBPACK_IMPORTED_MODULE_4__["default"].init();
  _js_slide_event__WEBPACK_IMPORTED_MODULE_5__["default"].init();
  npm_kit_ripple__WEBPACK_IMPORTED_MODULE_8__["default"].attach('.btn');
  npm_kit_ripple__WEBPACK_IMPORTED_MODULE_8__["default"].attach('.card-action');
  npm_kit_ripple__WEBPACK_IMPORTED_MODULE_8__["default"].attach('.waved');
  npm_kit_ripple__WEBPACK_IMPORTED_MODULE_8__["default"].deAttach('.btn--link');
}
...
window.addEventListener('toggleopen', function (event) {
...
window.addEventListener('toggleclose', function (event) {
  if (event.detail.target.id == 'categories-form') {
...
function swipemoveHandler(event) {
  ...
  var percent = 100 * event.detail.distX / document.body.clientWidth;
  ...
  menu.style.setProperty('--transform', "translateX(".concat(percent, "%)"));
  ...
  if (event.detail.distX > 100) {
    ...
    setTimeout(function () {
      if (!menu.classList.contains('toggle-active')) {
        npm_kit_toggle__WEBPACK_IMPORTED_MODULE_7__["default"].toggle('menu');
        clear();
      }
    }, 500);
    return;
